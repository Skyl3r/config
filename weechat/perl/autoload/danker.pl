...
my $script_name = "danker";
my $author = "keveloper";
my $version = "0.1";
my $license = "GPL3";
my $description = "uppercases adds tildas and spaces characters for the most dank response";
...
sub danker {
	...
	$finalText = "~ ~ ~ " + uc $text + " ~ ~ ~";
	weechat::buffer_set(weechat::current_buffer, "input", $finalText);
